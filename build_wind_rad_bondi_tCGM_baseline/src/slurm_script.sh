...
#SBATCH --job-name="10kyr_no_bubble_tCGM"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi_tCGM_baseline/tCGM_baseline_10kyr.athinput -d tCGMBaselineWindRadBondi10kyrOut
