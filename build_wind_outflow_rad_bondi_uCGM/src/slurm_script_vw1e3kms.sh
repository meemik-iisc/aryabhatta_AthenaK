...
#SBATCH --job-name="uCGM_vw3_10MyrOut"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_outflow_rad_bondi_uCGM/uCGM_vw3_10kpcBox_10MyrOut.athinput -d uCGMvw310kpcBox10MyrOut
