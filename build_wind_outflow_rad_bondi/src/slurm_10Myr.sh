...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_outflow_rad_bondi/wind_outflow_rad_bondi_vw_1e3kms_10kpc_box_10Myr.athinput -d windOutflowBox1e3kms10kpcRadBondi10MyrOut
