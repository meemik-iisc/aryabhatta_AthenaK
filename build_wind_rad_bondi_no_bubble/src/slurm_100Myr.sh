...
#SBATCH --job-name="10kpc_box_100Myr_no_bubblw_wind_rad_bondi_accr"
#SBATCH -p normal
...
mpirun -np $SLURM_NTASKS ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/nobubble_10kpc_box_wind_rad_bondi_100Myr.athinput -d noBubble10kpcBoxWindRadBondi100MyrOut
