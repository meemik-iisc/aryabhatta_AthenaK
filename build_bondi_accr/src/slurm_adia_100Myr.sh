...
#SBATCH --job-name="100Myr_adia_bondi_accr"
...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/bondi/bondi_adia_100Myr.athinput -d adia100MyrBondiAccrOut
