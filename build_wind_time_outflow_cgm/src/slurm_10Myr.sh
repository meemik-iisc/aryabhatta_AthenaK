...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/time_outflow_cgm_wind_rad_bondi/ton_1Myr_tduty_05_mdot_4_cgm_dens_4e3_wind_outflow_rad_bondi_vw_1e3kms_10kpc_box_10Myr.athinput -d ton1Myrtduty05CGMMdot4dens4e3windOutflowBox1e3kms10kpcRadBondi10MyrOut
