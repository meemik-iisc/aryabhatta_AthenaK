...
#SBATCH --job-name="time_outflow_cgm"
#SBATCH -p normal
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/time_outflow_cgm_wind_rad_bondi/time_5Myr_cgm_dens_4e3_wind_outflow_rad_bondi_vw_5e3kms_10kpc_box_10Myr.athinput -d time5MyrCGMdens4e3windOutflowBox5e3kms10kpcRadBondi10MyrOut
