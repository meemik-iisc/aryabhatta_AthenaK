...
#SBATCH --job-name="01pcbubble_dens10mpcc_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/bubble_dens10mpcc_01pc_box10pc_wind_rad_bondi_10kyr.athinput -d bubbleDens10mpcc01pcWindRadBondi10kyrOut
