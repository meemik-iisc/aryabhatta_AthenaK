...
#SBATCH --job-name="1pcbubble_dens1e4_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/bubble_dens1e4mpcc_1pc_box10pc_wind_rad_bondi_10kyr.athinput -d bubbleDens1e41pcWindRadBondi10kyrOut
