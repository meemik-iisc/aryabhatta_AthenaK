...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/no_wind_bubble01pc_dens10mpcc_01pc_box10pc_wind_rad_bondi_10kyr.athinput -d noWindBubble01pcDens10mpccWindRadBondi10kyrOut
