...
#SBATCH --job-name="01pcbubble_100pcbox_dens10mpcc_100kyr_wind_rad_bondi_accr"
...
mpirun -np 100 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/bubble_dens10mpcc_01pc_box100pc_wind_rad_bondi_100kyr.athinput -d bubble01pcDens10mpccBox100pcWindRadBondi100kyrOut
