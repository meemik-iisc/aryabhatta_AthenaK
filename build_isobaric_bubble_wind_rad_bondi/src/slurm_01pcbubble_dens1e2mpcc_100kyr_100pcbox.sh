...
#SBATCH --job-name="01pcbubble_100pcbox_dens1e2mpcc_100kyr_wind_rad_bondi_accr"
...
mpirun -np 100 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/bubble_dens1e2mpcc_01pc_box100pc_wind_rad_bondi_100kyr.athinput -d bubble01pcDens1e2mpccBox100pcWindRadBondi100kyrOut
