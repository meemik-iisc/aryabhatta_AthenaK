...
#SBATCH --job-name="01pcbubble_dens1mpcc_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble/bubble_dens1mpcc_01pc_box10pc_wind_rad_bondi_10kyr.athinput -d bubbleDens1mpcc01pcWindRadBondi10kyrOut
