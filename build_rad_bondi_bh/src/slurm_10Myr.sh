...
#SBATCH --job-name="10Myr_dens_1mpcc_rad_bondi_bh"
#SBATCH -p normal
...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/rad_bondi_bh/dens_1mpcc_rad_bondi_bh_10Myr.athinput -d dens1mpccRadBondi10MyrAccrOut
