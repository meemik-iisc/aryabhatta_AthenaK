...
#SBATCH --job-name="10Myr_dens_1_mpcc_10kpc_box_wind_rad_bondi_accr"
#SBATCH -p normal
...
mpirun -np $SLURM_NTASKS ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi_bh/no_wind_dens_1_mp_10kpc_box_wind_rad_bondi_10Myr.athinput -d noWinddens1mpcc10kpcBoxWindRadBondi10MyrAccrOut
