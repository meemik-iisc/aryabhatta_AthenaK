...
mpirun -np $SLURM_NTASKS ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi_bh/dens_1_mp_10kpc_box_wind_rad_bondi_100Myr.athinput -d dens1mpcc10kpcBoxWindRadBondi100MyrAccrOut
