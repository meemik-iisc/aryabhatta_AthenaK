...
#SBATCH --job-name="time_cgm_10Myr_wind_1e2kms_outflow_rad_bondi"
#SBATCH -p normal
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_outflow_time_cgm/time_cgm_dens_4e3_wind_outflow_rad_bondi_vw_1e2kms_10kpc_box_10Myr.athinput -d timeCGMdens4e3windOutflowBox1e2kms10kpcRadBondi10MyrOut
