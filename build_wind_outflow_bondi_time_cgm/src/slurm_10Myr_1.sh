...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_outflow_time_cgm/time_cgm_dens_4e3_wind_outflow_rad_bondi_vw_1e4kms_10kpc_box_10Myr.athinput -d timeCGMdens4e3windOutflowBox1e4kms10kpcRadBondi10MyrOut
