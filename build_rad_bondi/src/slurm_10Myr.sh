...
#SBATCH --job-name="10Myr_rad_bondi_accr"
...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/rad_bondi/rad_bondi_10Myr.athinput -d radBondi10MyrAccrOut
