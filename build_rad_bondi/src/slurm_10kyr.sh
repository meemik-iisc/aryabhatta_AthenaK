...
#SBATCH --job-name="10kyr_rad_bondi_accr"
...
mpirun -np 36 ./athena -i /scratch/meemik/athenak/inputs/hydro/rad_bondi/rad_bondi_10kyr.athinput -d radBondi10kyrAccrOut
