...
#SBATCH --job-name="10Myr_dens_10mpcc_wind_rad_bondi_accr"
...
mpirun -np 64 ../athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/dens_10_mp_wind_rad_bondi_10Myr.athinput -d dens10mpccWindRadBondi10MyrAccrOut
