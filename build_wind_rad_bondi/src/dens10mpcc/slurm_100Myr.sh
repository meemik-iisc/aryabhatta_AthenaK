...
#SBATCH --job-name="100Myr_dens_10_mpcc_10kpc_box_wind_rad_bondi_accr"
...
mpirun -np $SLURM_NTASKS ../athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/dens_10_mp_10kpc_box_wind_rad_bondi_100Myr.athinput -d adiaDens10mpccWindRadBondi100MyrAccrOut
