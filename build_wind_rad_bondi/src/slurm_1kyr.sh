...
#SBATCH --job-name="1kyr_no_bubble_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/nobubble_3kpc_box_wind_rad_bondi_1kyr.athinput -d noBubbleWindRadBondi1kyrOut
