...
#SBATCH --job-name="100Myr_wind_rad_bondi_accr"
...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/wind_rad_bondi_100Myr.athinput -d windRadBondi100MyrAccrOut
