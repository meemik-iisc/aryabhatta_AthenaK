...
#SBATCH --job-name="10Myr_dens_1mpcc_wind_rad_bondi_accr"
...
mpirun -np 64 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/dens_1_mp_wind_rad_bondi_10Myr.athinput -d dens1mpccWindRadBondi10MyrAccrOut
