...
#SBATCH --job-name="ram_40pcbox_dens1mpcc_01pcbubble_10kyr_wind_rad_bondi_accr"
...
mpirun -np 18 ../athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/bubble_ram_dens1mpcc_01pc_box40pc_wind_rad_bondi_10kyr.athinput -d ramBubbledens1mpcc01pcWindRadBondi40pcBox10kyrOut
