...
#SBATCH --job-name="dens01mpcc_01pcbubble_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/bubble_dens01mpcc_01pc_box10pc_wind_rad_bondi_10kyr.athinput -d bubbledens01mpcc01pcWindRadBondi10kyrOut
