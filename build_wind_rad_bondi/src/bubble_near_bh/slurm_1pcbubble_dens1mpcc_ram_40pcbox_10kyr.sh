...
#SBATCH --job-name="1pcbubble_ram_40pcbox_dens1mpcc_10kyr_wind_rad_bondi_accr"
...
mpirun -np 18 ../athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/bubble_ram_dens1mpcc_1pc_box40pc_wind_rad_bondi_10kyr.athinput -d ramBubbledens1mpcc1pcWindRadBondi40pcBox10kyrOut
