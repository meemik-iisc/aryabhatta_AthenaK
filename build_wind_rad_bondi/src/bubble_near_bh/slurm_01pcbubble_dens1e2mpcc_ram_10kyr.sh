...
#SBATCH --job-name="ram_dens1e2mpcc_01pcbubble_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ../athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/bubble_ram_dens1e2mpcc_box10pc_wind_rad_bondi_10kyr.athinput -d ramBubbledens1e2mpcc01pcWindRadBondi10kyrOut
