...
#SBATCH --job-name="1pcbubble_20kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/wind_rad_bondi/bubble_1pc_box10pc_wind_rad_bondi_20kyr.athinput -d bubble1pcWindRadBondi20kyrOut
