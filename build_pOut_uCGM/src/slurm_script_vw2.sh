...
#SBATCH --job-name="pOut_uCGM_vw2_10MyrOut"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/pOut_uCGM/pOut_vw2_ton1Myr_tduty_05_uCGM_10kyrBox_10MyrOut.athinput -d pOuttOn1MyrtDuty05uCGMvw210kpcBox10MyrOut
