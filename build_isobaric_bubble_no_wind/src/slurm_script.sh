...
#SBATCH --job-name="nowind_01pcbubble_dens10_10kyr_wind_rad_bondi_accr"
...
mpirun -np 16 ./athena -i /scratch/meemik/athenak/inputs/hydro/isobaric_bubble_no_wind/no_wind_bubble01pc_dens10mpcc_01pc_box10pc_wind_rad_bondi_10kyr.athinput -d noWindBubble01pcDens10mpccWindRadBondi10kyrOut
